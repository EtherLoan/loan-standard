...
contract Loan {
    ...
    /// @param from who send the funds to contribute.
    /// @param lender is the lender.
    ...
    /// @param from is who send the funds to payback.
    /// @param borrower who ask for the loan.
